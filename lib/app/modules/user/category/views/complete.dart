...
getClassEx(UserCategoryController  controller) {
  return Expanded(
    child: GetBuilder<UserCategoryController>(
      builder: (ctrl) {
        if (ctrl.companyStatus == ApiCallStatus.success) {
          return RefreshIndicator(
            onRefresh: () => ctrl.getCompanies(1, null),
          ...
          return Center(child: Text(Strings.There_are_institutions.tr));
        }
      },
    ),
  );
...
class ListItem extends StatelessWidget {
  ...
  const ListItem({Key? key, required this.company}) : super(key: key);
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: Booster.textBody(context, company.desceptionAr!,
                          withHeight: false, textSize: 10),
                    )
                    // Booster.textBody(context, company.desceptionAr! , withHeight: false, textSize: 10),
